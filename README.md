...
Firmware mới có địa chỉ OTA trỏ tới repo này. Các binary cũ được chuyển sang đây vẫn giữ nguyên byte và địa chỉ OTA cũ. Đọc [hướng dẫn chuyển OTA](OTA-MIGRATION.md) trước khi kỳ vọng máy cũ tự nhận bản mới.
